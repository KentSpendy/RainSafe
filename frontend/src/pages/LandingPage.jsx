  ...
  return (
    <div className="min-h-screen bg-sky-50">
      ...
      <nav className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            <FaCloudRain className="text-blue-500 text-2xl" />
            <span className="text-xl font-bold text-blue-600">RainSafe</span>
          </div>
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <button className="border border-blue-600 text-blue-600 hover:bg-blue-50 px-6 py-3 rounded-md text-lg font-medium transition-colors">
                Learn More
              </button>
            </div>
          </div>
          <div className="md:w-1/2">
            <img 
              src="https://placehold.co/600x400/e0f2fe/1e40af?text=RainSafe+Dashboard" 
      ...
      <section id="features" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-blue-900 mb-4">Why Choose RainSafe?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-sky-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <div className="bg-blue-100 p-3 rounded-full w-14 h-14 flex items-center justify-center mb-4">
                <FaCloudRain className="text-blue-600 text-2xl" />
              </div>
              <h3 className="text-xl font-semibold text-blue-900 mb-2">Real-Time Monitoring</h3>
            ...
            <div className="bg-sky-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-blue-900 mb-2">Instant Alerts</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-sky-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-blue-900 mb-2">Detailed Analytics</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-sky-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-blue-900 mb-2">Mobile Accessibility</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-sky-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              <div className="bg-blue-100 p-3 rounded-full w-14 h-14 flex items-center justify-center mb-4">
                <FaUmbrella className="text-blue-600 text-2xl" />
              </div>
              <h3 className="text-xl font-semibold text-blue-900 mb-2">Precipitation Forecasting</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-sky-50 p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-blue-900 mb-2">Safety Recommendations</h3>
              <p className="text-gray-600">
      ...
      <section id="how-it-works" className="py-16 bg-blue-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-blue-900 mb-4">How RainSafe Works</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 md:space-x-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-1/3 text-center">
              ...
              <h3 className="text-xl font-semibold text-blue-900 mb-2">Install & Setup</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-1/3 text-center">
              ...
              <h3 className="text-xl font-semibold text-blue-900 mb-2">Monitor Weather</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md w-full md:w-1/3 text-center">
              ...
              <h3 className="text-xl font-semibold text-blue-900 mb-2">Receive Alerts</h3>
              <p className="text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-sky-50 p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-blue-200 rounded-full mr-4"></div>
                <div>
                  <h4 className="font-semibold text-blue-900">Emily Rodriguez</h4>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-500 to-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <button className="bg-white text-blue-600 hover:bg-blue-50 px-8 py-3 rounded-md text-lg font-medium transition-colors">
              Download Now
            </button>
            <button className="border border-white text-white hover:bg-blue-600 px-8 py-3 rounded-md text-lg font-medium transition-colors">
              Learn More
            </button>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-blue-400 transition-colors">GDPR</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-400">support@rainsafe.com</span>
                </li>
                <li className="flex items-center space-x-2">
                  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-400">123 Weather Lane, Cloud City, CA 94123</span>
                </li>
              </ul>
            </div>
          </div>
